...
export default function DuzenleKamuAr({ params }: { params: Promise<{ slug: string }> }) {
  ...
  return (
    <div className="space-y-6 p-6">
      <button onClick={() => router.push('/admin/kamu-ar')} className="inline-flex items-center text-red-600">
        ...
        <div className="space-y-6">
          ...
          <div className="bg-white p-6 rounded-lg border shadow-sm">
            <button 
              type="submit"
              disabled={saving} 
              className="w-full inline-flex items-center justify-center px-6 py-3 bg-blue-600 text-white rounded-lg hover:bg-blue-700 focus:ring-4 focus:ring-blue-200 disabled:opacity-50 disabled:cursor-not-allowed transition-colors"
            >
