...
export default function RaporYeni() {
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    try {
      ...
      // 2. Rapor kaydını veritabanına yaz
      const payload = {
        title,
        summary,
        imageUrl: coverUrl,
      ...
      router.push("/admin/basin-yayin/rapor");
  ...
  return (
    <div className="max-w-xl mx-auto p-6">
      <h1 className="text-2xl font-bold mb-4">Yeni Rapor Ekle</h1>
