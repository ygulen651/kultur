...
export default function YeniKulturSanatIs() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const res = await fetch('/api/kultur-sanat-is', { method: 'POST', headers: { Authorization: `Bearer ${token}` }, body: fd })
  ...
  return (
    <div className="space-y-6">
      ...
      <h1 className="text-2xl font-bold">Yeni Kültür Sanat-İş</h1>
